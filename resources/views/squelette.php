...
<body class="fix-header fix-sidebar mini-sidebar" >
    ...
    <!-- Main wrapper  -->
      <div id="main-wrapper">
        <!-- header header  -->
        <div class="header" >
            <nav class="navbar top-navbar navbar-expand-md " style="background-color: #0000FD;height: 56px;" >
                <!-- Logo -->
                ...
                <div class="navbar-collapse">
                    ...
                    <!-- Comment -->
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/users/gh.bmp" alt="user" class="profile-pic"></a>
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn" style="width: 250px;">
                                <ul class="dropdown-user">
                                    <li><a href="#"><i class="ti-user"></i> </a></li>
                                    <li><a href="#"><i class="ti-wallet"></i>  </a></li>
                                    <li><a href="#"><i class="ti-email"></i> </a></li>
                                    <li><a href="#"><i class="ti-settings"></i> </a></li>
                                    <li><a href="auth/passwords/login.blade.php"><i class="fa fa-power-off"></i> Déconnection </a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="slimScrollDiv" style="position: relative; overflow: visible; width: auto; height: 100%;">
                ...
                <nav class="sidebar-nav active" style="padding-top: 12px;background-color: #0a0a0a">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="#" style= "background-color: #0a0a0a"; ><i class="fa fa-tachometer" style=""></i><span style="font-size: 15px; "><b> FENOUIL </b> </span></a>
                        </li>
                        
                        
                        <li class="nav-label">Edition</li>
                        <li class="nav-devider"></li>
                        <li> <a class="has-arrow " href="#" aria-expanded="false" style="background-color: #0a0a0a;" ><i class="fa fa-file"></i><span class="hide-menu">Publicité</span></a>
...
<!-- hnaaaaaaaaaaaaaaaaaaaaaaaaaaaaa ktab l code      --> 
    ...
    <script src="js/morris-chart/dashboard1-init.js"></script>
